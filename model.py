...
# Channel independent feature maps (3D features)
# using https://www.tensorflow.org/versions/r0.11/api_docs/python/nn.html#depthwise_conv2d_native
...
class CNN():
    ...
    def get_vgg_weights(self, layer_name, bias=False):
        ...
        # transpose because VGG weights were stored in different order
